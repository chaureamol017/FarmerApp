...
export class SignupComponent implements OnInit {
  ...
  ngOnInit() {
    this.signupForm = new FormGroup({
      registrationFor: new FormControl('', [Validators.required]),
    ...
    if (!formValues.password || !formValues.confirmPassword) {
      alert("Please add password.");
        ...
        alert("Password does not match.")
          ...
          signupDetails.registrationFor = formValues.registrationFor;
          signupDetails.firstName = formValues.firstName;
          signupDetails.middleName = formValues.firstName;
          signupDetails.lastName = formValues.middleName;
